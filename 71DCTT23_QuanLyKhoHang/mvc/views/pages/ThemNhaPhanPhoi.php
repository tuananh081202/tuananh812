...
<body style="margin-top:160px ;">
    ...
    <form action="http://localhost/71DCTT23_QuanLyKhoHang/NhaPhanPhoi/XuLyThem_NhaPhanPhoi" method="POST" >
        <?php
    ...
    ?>
        ...
        <tr>
                ...
                value="<?php if(isset($data['manpp'])) echo $data['manpp']?>">
                </td>
            </tr>
            <tr>
                ...
                value="<?php if(isset($data['tennpp'])) echo $data['tennpp']?>">
                </td>
            </tr>
            <tr>
                <td>
